...
├── repaired_models //repaired models
    └── repaired_anonymous_1.h5
    └── repaired_anonymous_2.h5 
    └── repaired_multi.h5
...
For example: `python3 eval_anonymous2.py data/test_image.png`. Here, eval_anonymous2.py is designed for anonynous_2_bd_net.h5 model.  Output should be either 1283 (if test_image.png is poisoned) or one class in range [0, 1282] (if test_image.png is not poisoned).
